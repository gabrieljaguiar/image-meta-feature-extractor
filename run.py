...
from utils.extractor_gray import extract_gray_features
from utils.extractor_meta import extract_meta_features
from utils.extractor_color import extract_color_features
import sys
...
meta_features_names = ['attributes', 'samples', 'dimension', 'cor_RG', 'cor_RB', 'cor_RH', 'cor_RS', 'cor_RV', 'cor_RI', 'cor_GB', 'cor_GH',
                       'cor_GS', 'cor_GV', 'cor_GI', 'cor_BH', 'cor_BS', 'cor_BV', 'cor_BI', 'cor_HS', 'cor_HV', 'cor_HI', 'cor_SV', 'cor_SI', 'cor_VI']
color_features_names = ['mean_H', 'std_H', 'mean_S', 'std_S', 'mean_V', 'std_V', 'std_hist_H', 'kurt_hist_H',
                        'skew_hist_H', 'std_hist_S', 'kurt_hist_S', 'skew_hist_S', 'std_hist_V', 'kurt_hist_V', 'skew_hist_V']
color_features_names = color_features_names + ['mean_R', 'std_R', 'mean_G', 'std_G', 'mean_B', 'std_B', 'std_hist_R',
                                               'kurt_hist_R', 'skew_hist_R', 'std_hist_G', 'kurt_hist_G', 'skew_hist_G', 'std_hist_B', 'kurt_hist_B', 'skew_hist_B']
color_features_names = color_features_names + \
    ['nump_sobel', 'hu_sobel1', 'hu_sobel2', 'hu_sobel3',
        'hu_sobel4', 'hu_sobel5', 'hu_sobel6', 'hu_sobel7']
color_features_names = color_features_names + \
    ['nump_canny', 'hu_canny1', 'hu_canny2', 'hu_canny3',
        'hu_canny4', 'hu_canny5', 'hu_canny6', 'hu_canny7']
...
features_names = ['Name_file'] + meta_features_names + \
    color_features_names + gray_features_names
#rotulos = []
...
csv_file = pd.DataFrame(
    csv_complete[1:len(csv_complete)], columns=features_names)
